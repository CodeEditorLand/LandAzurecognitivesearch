...
This extension includes snippets for all major resources within Azure Cognitive
Search including indexes, indexers, skillsets, data sources, and synonym maps.
...
```json
{
	...
	"context": "/document/normalized_images/*",
	"defaultLanguageCode": "en",
	"visualFeatures": ["tags", "categories", "description", "faces", "brands"],
	"inputs": [
		{
			"name": "image",
			"source": "/document/normalized_images/*"
